...
class ReuniaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reuniao" do
    assert_difference('Reuniao.count') do
      post reuniaos_url, params: { reuniao: { data: @reuniao.data, descricao: @reuniao.descricao, nome_completo: @reuniao.nome_completo } }
    end
  ...
  test "should update reuniao" do
    patch reuniao_url(@reuniao), params: { reuniao: { data: @reuniao.data, descricao: @reuniao.descricao, nome_completo: @reuniao.nome_completo } }
